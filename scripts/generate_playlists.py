...
Generate 2 file playlist dari channel.json:
  - playlist.m3u8           -> semua channel pakai URL PROXY (domain vidiraplay)
  - playlist-original.m3u8  -> semua channel pakai URL ORIGIN asli
...
# Domain proxy yang dipakai buat playlist.m3u8 (URL yang disembunyikan origin-nya)
...
def build():
    ...
    print(f"Generated {OUT_PROXY} dan {OUT_ORIGINAL} - total {total} channel di {len(group_keys)} grup.")
